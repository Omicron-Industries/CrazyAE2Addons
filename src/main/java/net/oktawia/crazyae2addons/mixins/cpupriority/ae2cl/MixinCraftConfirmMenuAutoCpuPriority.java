...
public abstract class MixinCraftConfirmMenuAutoCpuPriority {
    ...
    @ModifyArg(method = "startJob(Z)V", at = @At(value = "INVOKE", target = "Lappeng/api/networking/crafting/ICraftingService;submitJob(Lappeng/api/networking/crafting/ICraftingPlan;Lappeng/api/networking/crafting/ICraftingRequester;Lappeng/api/networking/crafting/ICraftingCPU;ZLappeng/api/networking/security/IActionSource;Z)Lappeng/api/networking/crafting/ICraftingSubmitResult;"), index = 2)
