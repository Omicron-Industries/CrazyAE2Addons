...
public final class CrazyFeatureGates {
    ...
    public static void register() {
        ...
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.EMITTER_TERMINAL_ENABLED.get(), CrazyItemRegistrar.EMITTER_TERMINAL);
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.EMITTER_TERMINAL_ENABLED.get() || !c.WIRELESS_EMITTER_TERMINAL_ENABLED.get(),
        ...
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.MULTI_LEVEL_EMITTER_ENABLED.get(), CrazyItemRegistrar.MULTI_LEVEL_EMITTER);
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.TAG_LEVEL_EMITTER_ENABLED.get(), CrazyItemRegistrar.TAG_LEVEL_EMITTER);
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.REDSTONE_EMITTER_TERMINAL_ENABLED.get(), CrazyItemRegistrar.REDSTONE_TERMINAL);
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.REDSTONE_EMITTER_TERMINAL_ENABLED.get(), CrazyItemRegistrar.REDSTONE_EMITTER);
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.REDSTONE_EMITTER_TERMINAL_ENABLED.get() || !c.WIRELESS_REDSTONE_TERMINAL_ENABLED.get(),
        ...
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.PATTERN_MULTIPLIER_ENABLED.get(), CrazyItemRegistrar.PATTERN_MULTIPLIER);
        ...
        FeatureGates.gate(CrazyAddons.MODID, () -> !c.CRAZY_PATTERN_PROVIDER_BLOCK_ENABLED.get() && !c.CRAZY_PATTERN_PROVIDER_PART_ENABLED.get(),
