...
public final class CrazyRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<FabricationRecipe>> FABRICATION_SERIALIZER = RECIPE_SERIALIZERS
            .register("fabrication", () -> FabricationRecipeSerializer.INSTANCE);

    public static final RegistryObject<RecipeType<FabricationRecipe>> FABRICATION_TYPE = RECIPE_TYPES
            .register("fabrication", () -> FabricationRecipeType.INSTANCE);

    public static final RegistryObject<RecipeSerializer<CrazyProviderConversionRecipe>> CRAZY_PROVIDER_CONVERSION = RECIPE_SERIALIZERS
            .register(
