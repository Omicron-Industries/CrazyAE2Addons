    ...
    public static final class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            builder.comment(
                    ...
                    "all level emitters in the connected grid from a single terminal.").push("emitterTerminal");
            ...
            builder.comment(
                    ...
                    "when they are above or below a given threshold.").push("wirelessNotificationTerminal");
            ...
            builder.comment(
                    ...
                    "and can monitor multiple resources at once.").push("tagLevelEmitter");
            ...
            builder.comment(
                    ...
                    "of connected redstone emitters.").push("redstoneEmitterTerminal");
            ...
            builder.comment(
                    ...
                    "outputs to the same input.").push("wormhole");
            ...
            builder.comment(
                    ...
                    "even across multiple insertions.").push("roundRobinP2p");
            ...
            builder.comment(
                    ...
                    "and use machines before lower-priority CPUs.").push("cpuPriorities");
            ...
            builder.comment(
                    ...
                    "instead of selected individual resources.").push("tagViewCell");
            ...
            builder.comment(
                    ...
                    "such as a pattern provider or chest when shift-right-clicked on it.").push("patternMultiplier");
            ...
            builder.comment(
                    ...
                    "Each upgrade adds 1 row (9 slots) to the pattern inventory.").push("crazyPatternProvider");
            ...
            builder.comment(
                    ...
                    "using one crafting job / CPU.").push("ejector");
            ...
            builder.comment(
                    ...
                    "and can highlight the consuming block in the world.").push("resourceTrackingTerminal");
