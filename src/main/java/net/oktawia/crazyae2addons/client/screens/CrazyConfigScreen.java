...
public class CrazyConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_DISPLAY, entries -> {
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_DISPLAY_DATABASE_ENABLED, cfg.DISPLAY_DATABASE_ENABLED.get(), true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_EMITTER_TERMINAL, entries -> {
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_WIRELESS_ENABLED, cfg.WIRELESS_EMITTER_TERMINAL_ENABLED.get(), true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_WIRELESS_NOTIFICATION_TERMINAL, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_CONFIG_SLOTS,
                    cfg.WIRELESS_NOTIFICATION_TERMINAL_CONFIG_SLOT.get(), 16, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_MULTI_LEVEL_EMITTER, entries -> {
            ...
            entries.add(
                    integer(eb, LangDefs.CONFIG_ENTRY_CONFIG_SLOTS, cfg.MULTI_LEVEL_EMITTER_CONFIG_SLOT.get(), 16, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_REDSTONE_EMITTER_TERMINAL, entries -> {
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_WIRELESS_ENABLED, cfg.WIRELESS_REDSTONE_TERMINAL_ENABLED.get(), true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_WORMHOLE, entries -> {
            ...
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_TELEPORTATION_ENABLED, cfg.WORMHOLE_TELEPORTATION_ENABLED.get(),
                    true,
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_NESTED_P2PS_ENABLED, cfg.WORMHOLE_NESTED_P2PS_ENABLED.get(), false,
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_FLUID_PROXY_ENABLED, cfg.WORMHOLE_FLUID_PROXY_ENABLED.get(), true,
            ...
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_OTHER_CAPABILITY_PROXY_ENABLED,
                    cfg.WORMHOLE_OTHER_CAPABILITY_PROXY_ENABLED.get(), true,
            ...
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_MERGED_CAPABILITY_PROXY_ENABLED,
                    cfg.WORMHOLE_MERGED_CAPABILITY_PROXY_ENABLED.get(), true,
            ...
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_REMOTE_INTERACTIONS_ENABLED,
                    cfg.WORMHOLE_REMOTE_INTERACTIONS_ENABLED.get(), true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_CRAZY_PATTERN_PROVIDER, entries -> {
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_BLOCK_ENABLED, cfg.CRAZY_PATTERN_PROVIDER_BLOCK_ENABLED.get(), true,
                            cfg.CRAZY_PATTERN_PROVIDER_BLOCK_ENABLED::set,
                            LangDefs.CONFIG_DESC_CRAZY_PATTERN_PROVIDER_BLOCK));
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_PART_ENABLED, cfg.CRAZY_PATTERN_PROVIDER_PART_ENABLED.get(), true,
                            cfg.CRAZY_PATTERN_PROVIDER_PART_ENABLED::set,
                            LangDefs.CONFIG_DESC_CRAZY_PATTERN_PROVIDER_PART));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_MAX_UPGRADES_UNLIMITED, cfg.CRAZY_PROVIDER_MAX_UPGRADES.get(),
                    -1, -1,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_EJECTOR, entries -> {
            ...
            entries.add(
                    bool(eb, LangDefs.CONFIG_ENTRY_CRAFT_MISSING_ENABLED, cfg.EJECTOR_CRAFT_MISSING_ENABLED.get(), true,
