...
public final class InsaneEntityRegistrar {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, InsaneAddons.MODID);

    public static final RegistryObject<EntityType<PenroseBlackHoleEntity>> PENROSE_BLACK_HOLE =
            ENTITY_TYPES.register("penrose_black_hole", () ->
