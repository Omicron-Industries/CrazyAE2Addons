...
public class InsaneMenuRegistrar {
    ...
    public static final RegistryObject<MenuType<MobFarmControllerMenu>> MOB_FARM_CONTROLLER_MENU =
            reg("mob_farm_controller_menu", MobFarmControllerMenu::new, MobFarmControllerBE.class);

    public static final RegistryObject<MenuType<SpawnerExtractorControllerMenu>> SPAWNER_EXTRACTOR_CONTROLLER_MENU =
            reg("spawner_extractor_controller_menu", SpawnerExtractorControllerMenu::new, SpawnerExtractorControllerBE.class);

    public static final RegistryObject<MenuType<PortablePenroseSphereControllerMenu>> PORTABLE_PENROSE_SPHERE_CONTROLLER_MENU =
            reg("portable_penrose_sphere_controller_menu", PortablePenroseSphereControllerMenu::new, PortablePenroseSphereControllerBE.class);

    public static final RegistryObject<MenuType<PenroseInjectionPortMenu>> PENROSE_INJECTION_PORT_MENU =
            reg("penrose_injection_port_menu", PenroseInjectionPortMenu::new, PenroseInjectionPortBE.class);

    public static final RegistryObject<MenuType<PenroseHeatVentMenu>> PENROSE_HEAT_VENT_MENU =
            reg("penrose_heat_vent_menu", PenroseHeatVentMenu::new, PenroseHeatVentBE.class);

    public static final RegistryObject<MenuType<PenroseLaserMenu>> PENROSE_LASER_MENU =
            reg("penrose_laser_menu", PenroseLaserMenu::new, PenroseLaserBE.class);

    public static final RegistryObject<MenuType<PenroseHawkingVentMenu>> PENROSE_HAWKING_VENT_MENU =
            reg("penrose_hawking_vent_menu", PenroseHawkingVentMenu::new, PenroseHawkingVentBE.class);

    public static final RegistryObject<MenuType<PenroseEmitterMenu>> PENROSE_MASS_EMITTER_MENU =
            reg("penrose_mass_emitter_menu", PenroseEmitterMenu::new, PenroseMassEmitterBE.class);

    public static final RegistryObject<MenuType<PenroseEmitterMenu>> PENROSE_HEAT_EMITTER_MENU =
            reg("penrose_heat_emitter_menu", PenroseEmitterMenu::new, PenroseHeatEmitterBE.class);

    public static final RegistryObject<MenuType<ReinforcedMatterCondenserMenu>> REINFORCED_MATTER_CONDENSER_MENU =
            reg("reinforced_matter_condenser_menu", ReinforcedMatterCondenserMenu::new, ReinforcedMatterCondenserBE.class);
    ...
    public static final RegistryObject<MenuType<MobKeySelectorMenu>> MOB_KEY_SELECTOR_MENU =
            reg("mob_key_selector_menu", MobKeySelectorMenu::new, MobKeySelectorHost.class);

    public static final RegistryObject<MenuType<IOBusMenu>> MOB_EXPORT_BUS_MENU =
            reg("mob_export_bus_menu", IOBusMenu::new, MobExportBusPart.class);

    public static final RegistryObject<MenuType<MobFormationPlaneMenu>> MOB_FORMATION_PLANE_MENU =
            reg("mob_formation_plane_menu", MobFormationPlaneMenu::new, MobFormationPlanePart.class);
