...
public final class InsaneRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<ResearchRecipe>> RESEARCH_SERIALIZER = RECIPE_SERIALIZERS
            .register("research", () -> ResearchRecipeSerializer.INSTANCE);

    public static final RegistryObject<RecipeType<ResearchRecipe>> RESEARCH_TYPE = RECIPE_TYPES.register("research",
            () -> ResearchRecipeType.INSTANCE);

    public static final RegistryObject<RecipeSerializer<CradleRecipe>> CRADLE_SERIALIZER = RECIPE_SERIALIZERS
            .register("cradle", () -> CradleRecipeSerializer.INSTANCE);

    public static final RegistryObject<RecipeType<CradleRecipe>> CRADLE_TYPE = RECIPE_TYPES.register("cradle",
            () -> CradleRecipeType.INSTANCE);
