...
public class InsaneItemRegistrar {
    ...
    public static final RegistryObject<MultiblockBuilderItem> MULTIBLOCK_BUILDER =
            ITEMS.register("multiblock_builder",
    ...
    public static final RegistryObject<MobKeySelectorItem> MOB_KEY_SELECTOR =
            ITEMS.register("mob_key_selector",
                    () -> new MobKeySelectorItem(new Item.Properties()));

    public static final RegistryObject<MobAnnihilationPlanePartItem> MOB_ANNIHILATION_PLANE =
            ITEMS.register("mob_annihilation_plane",
                    () -> new MobAnnihilationPlanePartItem(new Item.Properties()));

    public static final RegistryObject<MobExportBusPartItem> MOB_EXPORT_BUS =
            ITEMS.register("mob_export_bus",
                    () -> new MobExportBusPartItem(new Item.Properties()));

    public static final RegistryObject<MobFormationPlanePartItem> MOB_FORMATION_PLANE =
    ...
    public static final RegistryObject<MobStorageCell> MOB_CELL_1K =
    ...
    public static final RegistryObject<MobStorageCell> MOB_CELL_4K =
    ...
    public static final RegistryObject<MobStorageCell> MOB_CELL_16K =
    ...
    public static final RegistryObject<MobStorageCell> MOB_CELL_64K =
    ...
    public static final RegistryObject<MobStorageCell> MOB_CELL_256K =
    ...
    public static final RegistryObject<UpgradeCardItem> LOOTING_UPGRADE_CARD =
            ITEMS.register("looting_upgrade_card",
                    () -> new UpgradeCardItem(new Item.Properties()));

    public static final RegistryObject<UpgradeCardItem> EXPERIENCE_UPGRADE_CARD =
            ITEMS.register("experience_upgrade_card",
                    () -> new UpgradeCardItem(new Item.Properties()));

    public static final RegistryObject<Item> SUPER_SINGULARITY =
