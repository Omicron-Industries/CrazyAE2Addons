...
public class PenroseInjectionPortBlock extends AbstractMenuOpeningBlock<PenroseInjectionPortBE> {

    public PenroseInjectionPortBlock() {
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new PenroseInjectionPortBE(pos, state);
    }
}
