...
public class EntropyCradleCapacitorBE extends AbstractMultiblockFrameBE<EntropyCradleControllerBE> {
    ...
    public EntropyCradleCapacitorBE(BlockPos pos, BlockState blockState) {
        super(
                InsaneBlockEntityRegistrar.ENTROPY_CRADLE_CAPACITOR_BE.get(),
                pos,
                blockState,
    ...
    public int getStoredEnergy() {
        EntropyCradleControllerBE controller = getResolvedController();
        return controller != null ? controller.getStoredEnergy() : 0;
    }
}
