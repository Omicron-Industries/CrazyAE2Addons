...
public final class InsaneConfig {
    ...
    public static final class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            builder.comment(
                    "Research feature.",
                    "The research multiblock unlocks insane fabrication recipes onto a Data Drive.").push("research");
            ...
            RESEARCH_UNIT_EXTRA_Q_BLOCKS = builder.comment(
                    ...
                    "blocks (1k-256k) are always allowed and counted separately.").defineList(
                            "unitExtraQBlocks",
                            List.of(),
            ...
            NBT_STORAGE_BUS_ENABLED = builder.comment(
                    "Enables the NBT storage bus.").define("nbtStorageBusEnabled", true);

            NBT_EXPORT_BUS_ENABLED = builder.comment(
                    "Enables the NBT export bus.").define("nbtExportBusEnabled", true);
            ...
            builder.comment(
                    ...
                    "emit a redstone signal based on the measured transfer rate.").push("ampereMeter");
            ...
            builder.comment(
                    ...
                    "Both cards work on the block and the cable part.").push("providerCards");
            ...
            builder.comment(
                    ...
                    "placed blocks keep storing power.").push("energyStorage");
            ...
            builder.comment(
                    ...
                    "block pattern placed inside its 5x5x5 chamber into a result block.").push("entropyCradle");
            ...
            builder.comment(
                    ...
                    "placed spheres keep running.").push("penroseSphere");
            ...
            PENROSE_EU_OUTPUT_ENABLED = builder.comment(
                    ...
                    "Has no effect without GregTech.").define("euOutputEnabled", true);
            ...
            builder.comment(
                    "Mass, heat and power curves. Changing these rebalances the whole feature.").push("balance");
            ...
            builder.comment(
                    ...
                    "the vent only cares that the fluid id resolves and that it is fed enough of it.").push("coolant");
            ...
            builder.comment(
                    "What happens when the sphere melts down.").push("meltdown");
            ...
            builder.comment(
                    ...
                    "inserts the mob it would spawn into the network as a mob key instead.").push("spawnerExtractor");

            SPAWNER_EXTRACTOR_PEACEFUL = builder.comment(
                    "Lets the spawner extractor keep working on peaceful difficulty.").define("worksOnPeaceful", true);
            ...
            builder.comment(
                    ...
                    "experience shards those mobs would drop when killed by a player.").push("mobFarm");
            ...
            builder.comment(
                    ...
                    "based on installed speed cards at the cost of network power.").push("entityTicker");

            ENTITY_TICKER_ENABLED = builder.comment(
                    "Enables the entity ticker part.").define("enabled", true);
