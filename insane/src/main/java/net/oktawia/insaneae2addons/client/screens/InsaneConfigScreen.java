...
public class InsaneConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_RESEARCH, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_UNIT_COMPUTATION_DIVISOR,
                    cfg.RESEARCH_UNIT_COMPUTATION_DIVISOR.get(), 16, 1,
                    cfg.RESEARCH_UNIT_COMPUTATION_DIVISOR::set,
                    LangDefs.CONFIG_DESC_RESEARCH_UNIT_COMPUTATION_DIVISOR));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_UNIT_COMPUTATION_POWER_COST,
                    cfg.RESEARCH_UNIT_COMPUTATION_POWER_COST.get(), 64, 0,
                    cfg.RESEARCH_UNIT_COMPUTATION_POWER_COST::set,
                    LangDefs.CONFIG_DESC_RESEARCH_UNIT_COMPUTATION_POWER_COST));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_UNIT_FLUID_DIVISOR,
                    cfg.RESEARCH_UNIT_FLUID_DIVISOR.get(), 4, 1,
                    cfg.RESEARCH_UNIT_FLUID_DIVISOR::set,
                    LangDefs.CONFIG_DESC_RESEARCH_UNIT_FLUID_DIVISOR));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_UNIT_FLUID_BUFFER,
                    cfg.RESEARCH_UNIT_FLUID_BUFFER.get(), 64_000, 1,
                    cfg.RESEARCH_UNIT_FLUID_BUFFER::set,
                    LangDefs.CONFIG_DESC_RESEARCH_UNIT_FLUID_BUFFER));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_UNIT_POWER_BUFFER,
                    cfg.RESEARCH_UNIT_POWER_BUFFER.get(), 200_000, 1,
                    cfg.RESEARCH_UNIT_POWER_BUFFER::set,
                    LangDefs.CONFIG_DESC_RESEARCH_UNIT_POWER_BUFFER));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_RESEARCH_STATION_PEDESTAL_RANGE,
                    cfg.RESEARCH_STATION_PEDESTAL_RANGE.get(), 3, 1,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_ENTROPY_CRADLE, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_CRADLE_CHARGING_SPEED, cfg.CRADLE_CHARGING_SPEED.get(),
                    10_000_000, 1,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_PENROSE, entries -> {
            ...
            entries.add(
                    integer(eb, LangDefs.CONFIG_ENTRY_PENROSE_MAX_FEED, cfg.PENROSE_MAX_FEED_PER_TICK.get(), 4_096, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_PENROSE_BALANCE, entries -> {
            entries.add(longValue(eb, LangDefs.CONFIG_ENTRY_PENROSE_CREATION_COST,
                    cfg.PENROSE_CREATION_COST_SINGU.get(), 32_512L, 0L, Long.MAX_VALUE,
                    cfg.PENROSE_CREATION_COST_SINGU::set,
                    LangDefs.CONFIG_DESC_PENROSE_CREATION_COST));
            entries.add(longValue(eb, LangDefs.CONFIG_ENTRY_PENROSE_INITIAL_MASS, cfg.PENROSE_INITIAL_MASS_MU.get(),
                    32_768L * 8_192L, 0L, Long.MAX_VALUE,
                    cfg.PENROSE_INITIAL_MASS_MU::set,
                    LangDefs.CONFIG_DESC_PENROSE_INITIAL_MASS));
            entries.add(longValue(eb, LangDefs.CONFIG_ENTRY_PENROSE_MASS_WINDOW, cfg.PENROSE_MASS_WINDOW_MU.get(),
                    1_113_600L, 0L, Long.MAX_VALUE,
                    cfg.PENROSE_MASS_WINDOW_MU::set,
                    LangDefs.CONFIG_DESC_PENROSE_MASS_WINDOW));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_MASS_FACTOR_MAX, cfg.PENROSE_MASS_FACTOR_MAX.get(),
                    2.0, 1.0, 64.0,
                    cfg.PENROSE_MASS_FACTOR_MAX::set,
                    LangDefs.CONFIG_DESC_PENROSE_MASS_FACTOR_MAX));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_DUTY_COMPENSATION,
                    cfg.PENROSE_DUTY_COMPENSATION.get(), 4.0 / 3.0, 0.0, 1000.0,
                    cfg.PENROSE_DUTY_COMPENSATION::set,
                    LangDefs.CONFIG_DESC_PENROSE_DUTY_COMPENSATION));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_FE_BASE, cfg.PENROSE_FE_BASE_PER_SINGU_FLOW.get(),
                    (double) (1L << 27) * 0.5, 0.0, 1.0e18,
                    cfg.PENROSE_FE_BASE_PER_SINGU_FLOW::set,
                    LangDefs.CONFIG_DESC_PENROSE_FE_BASE));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_HEAT_PER_FLOW, cfg.PENROSE_HEAT_PER_SINGU_FLOW.get(),
                    0.5, 0.0, 1.0e12,
                    cfg.PENROSE_HEAT_PER_SINGU_FLOW::set,
                    LangDefs.CONFIG_DESC_PENROSE_HEAT_PER_FLOW));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_HEAT_PEAK, cfg.PENROSE_HEAT_PEAK_MK.get(), 50_000.0,
                    1.0, 1.0e12,
                    cfg.PENROSE_HEAT_PEAK_MK::set,
                    LangDefs.CONFIG_DESC_PENROSE_HEAT_PEAK));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_MAX_HEAT, cfg.PENROSE_MAX_HEAT_MK.get(), 100_000.0,
                    0.0, 1.0e12,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_PENROSE_COOLANT, entries -> {
            entries.add(text(eb, LangDefs.CONFIG_ENTRY_PENROSE_COOLANT_FLUID, cfg.PENROSE_COOLANT_FLUID.get(),
                    "insaneae2addons:penrose_coolant",
                    cfg.PENROSE_COOLANT_FLUID::set,
                    LangDefs.CONFIG_DESC_PENROSE_COOLANT_FLUID));
            entries.add(decimal(eb, LangDefs.CONFIG_ENTRY_PENROSE_COOLANT_MB_PER_MK,
                    cfg.PENROSE_COOLANT_MB_PER_MK.get(), 125.0, 0.0001, 1.0e6,
                    cfg.PENROSE_COOLANT_MB_PER_MK::set,
                    LangDefs.CONFIG_DESC_PENROSE_COOLANT_MB_PER_MK));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_PENROSE_VENT_CAPACITY,
                    cfg.PENROSE_COOLANT_VENT_CAPACITY.get(), 64_000, 1,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_PENROSE_MELTDOWN, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_PENROSE_MELTDOWN_FIELD_RADIUS,
                    cfg.PENROSE_MELTDOWN_FIELD_RADIUS.get(), 768, 0, 4096,
                    cfg.PENROSE_MELTDOWN_FIELD_RADIUS::set,
                    LangDefs.CONFIG_DESC_PENROSE_MELTDOWN_FIELD_RADIUS));
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_PENROSE_MELTDOWN_FIELD_BUDGET,
                    cfg.PENROSE_MELTDOWN_FIELD_BUDGET_MICROS.get(), 100_000, 100, 200_000,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_MOB_FARM, entries -> {
            ...
            entries.add(
                    integer(eb, LangDefs.CONFIG_ENTRY_MOB_FARM_SPEED_PER_CARD, cfg.MOB_FARM_SPEED_PER_CARD.get(), 12, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_SPAWNER_EXTRACTOR, entries -> {
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_SPAWNER_EXTRACTOR_PEACEFUL, cfg.SPAWNER_EXTRACTOR_PEACEFUL.get(),
                    true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_ENTITY_TICKER, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_ENTITY_TICKER_MAX_SPEED_CARDS,
                    cfg.ENTITY_TICKER_MAX_SPEED_CARDS.get(), 8, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_NBT_TOOLS, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_NBT_EXPORT_BUS_TRANSFER_FACTOR,
                    cfg.NBT_EXPORT_BUS_TRANSFER_FACTOR.get(), 4, 1,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_AMPERE_METER, entries -> {
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_AMPERE_METER_INACTIVITY_RESET,
                    cfg.AMPERE_METER_INACTIVITY_RESET_TICKS.get(), 10, 0,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_BROKEN_PATTERN_PROVIDER, entries -> {
            entries.add(bool(eb, LangDefs.CONFIG_ENTRY_BROKEN_PATTERN_PROVIDER_ENABLED,
                    cfg.BROKEN_PATTERN_PROVIDER_ENABLED.get(), true,
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_ENERGY_STORAGE, entries -> {
            ...
            entries.add(integer(eb, LangDefs.CONFIG_ENTRY_ENERGY_STORAGE_CAPACITY_MULTIPLIER,
                    cfg.ENERGY_STORAGE_CAPACITY_MULTIPLIER.get(), 1, 1,
